...
#xterm -e " roslaunch turtlebot_gazebo turtlebot_world.launch world_file:=$(pwd)/src/my_robot/worlds/apartment.world " & sleep 5
xterm -e " roslaunch turtlebot_gazebo amcl_demo.launch " & sleep 5
xterm -e " roslaunch rvizConfig rvizConfig.launch " & sleep 5
xterm -e " rosrun add_markers add_markers " & sleep 5
